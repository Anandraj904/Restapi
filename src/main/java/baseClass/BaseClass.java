...
public class BaseClass {
	...
	public static Select elementSelect(WebElement element) {
		Select elementSelect = new Select(element);
	...
	public static void takesScreenShot(String imageName) throws IOException {
		...
		FileUtils.copyFile(srcFile,
				new File("C:\\Users\\anandraj\\eclipse-workspace\\Facebook_project\\screenshot" + imageName + ".png"));
	}
	...
	public static String title(String action) {
		...
		if (action.equalsIgnoreCase("title")) {
			...
			titletext = driver.getCurrentUrl();
		}
	...
	public static List<WebElement> selectGetAllOptions(WebElement element, String type) {
		Select elementSelect = new Select(element);
		List<WebElement> options = null;
		if (type.equalsIgnoreCase("gasoptions")) {
			options = elementSelect.getAllSelectedOptions();
		}

		else if (type.equalsIgnoreCase("goptions")) {
			options = elementSelect.getOptions();
		}
	...
	public static List<WebElement> elementFinds(String method, String element) {
		List<WebElement> findElement = null;
		if (method.equals("class")) {
			findElement = driver.findElements(By.className(element));
		} else if (method.equals("css")) {
			findElement = driver.findElements(By.cssSelector(element));
		} else if (method.equals("id")) {
			findElement = driver.findElements(By.id(element));
		} else if (method.equals("link")) {
			findElement = driver.findElements(By.linkText(element));
		} else if (method.equals("partial")) {
			findElement = driver.findElements(By.partialLinkText(element));
		} else if (method.equals("tag")) {
			findElement = driver.findElements(By.tagName(element));
		} else if (method.equals("xpath")) {
			findElement = driver.findElements(By.xpath(element));
		}
	...
	public static void actions(WebElement element, String type) {
		...
		if (type.equalsIgnoreCase("click")) {
			...
			;
		} else if (type.equalsIgnoreCase("clickanddouble")) {
			act.doubleClick(element).perform();
			;
		} else if (type.equalsIgnoreCase("double")) {
			act.click(element).doubleClick(element).build().perform();
		}
	}
